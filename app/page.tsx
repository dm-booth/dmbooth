    ...
    <div className="min-h-screen bg-white text-gray-900">
        ...
        <div className="max-w-6xl mx-auto px-6">
          ...
          <div className="grid md:grid-cols-3 gap-6 mt-8">
            ...
            <PriceCard
              name="웨딩/기업 PREMIUM"
              price="맞춤 견적"
              bullets={["브랜딩 풀커스텀", "대형 행사 동시 운영", "전용 배경/사인물", "데이터 리포트"]}
              cta="견적 받기"
            />
          </div>
      ...
      <section id="reviews" className="py-20">
        <div className="max-w-6xl mx-auto px-6">
          ...
          <div className="grid md:grid-cols-3 gap-6 mt-8">
            {[
              { q: "결혼식 날 디엠부스를 선택한 건 최고의 선택이었어요!✨
방명록을 볼 때마다 그날의 행복이 다시 떠오르고,
결혼식을 오래 기억에 남게 하는 최고의 아이템이라고 생각합니다!
꼭 친구들 결혼식에 하라고 추천할게요!😊", a: "웨딩 포토부스" },
      ...
      <section id="faq" className="py-20 bg-gray-50">
        <div className="max-w-6xl mx-auto px-6">
          ...
          <div className="mt-8 space-y-3">
            ...
            <Faq q="필름 추가 요금이 있나요?" a="800장 기준 장수 내 무제한 인화이며, 특별 요청으로 대량 추가 인화 시 옵션이 발생할 수 있습니다." />
            <Faq q="템플릿은 어떻게 커스터마이징 하나요?" a="행사 컨셉/컬러/로고/문구를 받아 1:1 맞춤으로 제작, 사전 확정 후 진행합니다." />
          </div>
        </div>
      </section>
