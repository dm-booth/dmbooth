        ...
        <div className="max-w-6xl mx-auto px-6">
          ...
          <div className="grid md:grid-cols-3 gap-6 mt-8">
            <PriceCard
              ...
              price="₩350,000~"
              highlight
              bullets={["겨울 이벤트", "1.5시간 진행", "현장 스태프 2명", "방명록&액자 제공", "맞춤 템플릿 1종"]}
              cta="상담 요청"
            />
            <PriceCard
              name="웨딩/기업 BASIC"
        ...
        <div className="max-w-6xl mx-auto px-6">
          ...
          <div className="grid md:grid-cols-3 gap-6 mt-8">
            {[
              ...
              {
  q: [
     "브랜드이미지 홍보 아이템으로 최고인듯 합니다!",
    "",
    "저희 로고가 들어간 커스텀 포토부스를 행사장 설치하니 저희가 직접 준비한 거 같아 만족도가 정말 높았어요.",
    "",
    "체험객들도 자발적으로 사진을 찍고 공유해주니, 전체적으로 캠페인 효과도 훨씬 잘 살아났고요",
    "",
...
},
{
  q: [
   "여름캠프 준비하면서 아이들에게 좋은 추억을 어떻게 남겨 줄까 걱정했는데,",
    ...
    "같이 참여한 부모님, 봉사자들 모두가 좋아했어요!☺",
    "준비한 사람으로서 정말 뿌듯했습니다 다음 캠프에도 꼭 다시 모시고 싶어요!"
  ],
  a: "ㅇㅇ교회 여름캠프"
},
            ].map((r, i) => (
